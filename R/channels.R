...
#' @seealso \code{\link{channelNames}} for channel labels,
#'   \code{\link{nChannels}} for channel count,
#'   \code{\link{setChannelTypes}} for assigning channel types
#' @export
#' @examples
#' pe <- PhysioExperiment(
...
#' electrophysiological data." \emph{Computational Intelligence and
#' Neuroscience}, 2011, 156869.
#' @seealso \code{\link{channelInfo}} for reading channel metadata,
...
#' electrophysiological data." \emph{Computational Intelligence and
#' Neuroscience}, 2011, 156869.
#' @seealso \code{\link{channelInfo}} for full channel metadata,
#'   \code{\link{renameChannels}} for renaming channels,
#'   \code{\link{nChannels}} for channel count
#' @export
#' @examples
#' pe <- PhysioExperiment(
...
#' electrophysiological data." \emph{Computational Intelligence and
#' Neuroscience}, 2011, 156869.
#' @seealso \code{\link{channelNames}} for reading channel labels,
#'   \code{\link{renameChannels}} for renaming specific channels,
#'   \code{\link{channelInfo}} for full channel metadata
#' @export
#' @examples
#' pe <- PhysioExperiment(
#'   assays = list(raw = matrix(rnorm(400), nrow = 100, ncol = 4)),
...
#' @seealso \code{\link{channelNames}} for channel labels,
#'   \code{\link{channelInfo}} for full channel metadata,
#'   \code{\link{pickChannels}} for subsetting channels
#' @export
#' @examples
#' pe <- PhysioExperiment(
#'   assays = list(raw = matrix(rnorm(400), nrow = 100, ncol = 4)),
...
#' electrophysiological data." \emph{Computational Intelligence and
#' Neuroscience}, 2011, 156869.
#' @seealso \code{\link{getChannelsByType}} for querying channels by type,
#'   \code{\link{channelInfo}} for full channel metadata,
#'   \code{\link{setChannelUnits}} for assigning physical units
#' @export
#' @examples
#' pe <- PhysioExperiment(
#'   assays = list(raw = matrix(rnorm(400), nrow = 100, ncol = 4)),
...
#' electrophysiological data." \emph{Computational Intelligence and
#' Neuroscience}, 2011, 156869.
#' @seealso \code{\link{setChannelTypes}} for assigning channel types,
#'   \code{\link{channelInfo}} for full channel metadata
#' @export
#' @examples
#' pe <- PhysioExperiment(
...
#' Neuroscience}, 2011, 156869.
#' @seealso \code{\link{setChannelTypes}} for assigning channel types,
#'   \code{\link{pickChannels}} for subsetting by channel,
...
#' electrophysiological data." \emph{Computational Intelligence and
#' Neuroscience}, 2011, 156869.
#' @seealso \code{\link{dropChannels}} for removing channels,
#'   \code{\link{getChannelsByType}} for finding channels by type,
#'   \code{\link{channelNames}} for available channel labels
#' @export
#' @examples
#' pe <- PhysioExperiment(
#'   assays = list(raw = matrix(rnorm(400), nrow = 100, ncol = 4)),
...
pickChannels <- function(x, channels) {
  ...
  # Validate numeric indices are in range
  n_ch <- nChannels(x)
  out_of_range <- channels[channels < 1 | channels > n_ch]
  if (length(out_of_range) > 0) {
    stop("Channel indices out of range (1-", n_ch, "): ",
  ...
  col_data <- SummarizedExperiment::colData(x)
  if (nrow(col_data) > 0) {
    col_data <- col_data[channels, , drop = FALSE]
  }
...
#' electrophysiological data." \emph{Computational Intelligence and
#' Neuroscience}, 2011, 156869.
#' @seealso \code{\link{pickChannels}} for keeping specific channels,
#'   \code{\link{getChannelsByType}} for finding channels by type,
#'   \code{\link{nChannels}} for channel count
#' @export
#' @examples
...
#' electrophysiological data." \emph{Computational Intelligence and
#' Neuroscience}, 2011, 156869.
#' @seealso \code{\link{getReference}} for reading the reference,
#'   \code{\link{channelInfo}} for full channel metadata,
#'   \code{\link{applyMontage}} for applying standard montages
#' @export
#' @examples
#' pe <- PhysioExperiment(
#'   assays = list(raw = matrix(rnorm(400), nrow = 100, ncol = 4)),
...
#' electrophysiological data." \emph{Computational Intelligence and
#' Neuroscience}, 2011, 156869.
#' @seealso \code{\link{setReference}} for setting the reference,
#'   \code{\link{channelInfo}} for full channel metadata
#' @export
#' @examples
#' pe <- PhysioExperiment(
...
#' electrophysiological data." \emph{Computational Intelligence and
#' Neuroscience}, 2011, 156869.
#' @seealso \code{\link{getElectrodePositions}} for reading positions,
#'   \code{\link{applyMontage}} for standard electrode layouts,
#'   \code{\link{channelInfo}} for full channel metadata
#' @export
#' @examples
#' pe <- PhysioExperiment(
...
#' electrophysiological data." \emph{Computational Intelligence and
#' Neuroscience}, 2011, 156869.
#' @seealso \code{\link{setElectrodePositions}} for setting positions,
#'   \code{\link{applyMontage}} for standard electrode layouts,
#'   \code{\link{channelNames}} for channel labels
#' @export
#' @examples
...
#' electrophysiological data." \emph{Computational Intelligence and
#' Neuroscience}, 2011, 156869.
#' @seealso \code{\link{setElectrodePositions}} for custom positions,
#'   \code{\link{getElectrodePositions}} for reading positions,
#'   \code{\link{channelNames}} for channel labels,
#'   \code{\link{setReference}} for reference electrode
#' @export
#' @examples
#' pe <- PhysioExperiment(
#'   assays = list(raw = matrix(rnorm(400), nrow = 100, ncol = 4)),
