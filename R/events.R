...
#' of single-trial EEG dynamics." \emph{Journal of Neuroscience Methods},
#' 134(1), 9-21.
#'
...
#' @seealso \code{\link{setEvents}} for attaching events to a PhysioExperiment,
#'   \code{\link{getEvents}} for retrieving events,
#'   \code{\link{nEvents}} for event count
#' @export
#' @examples
...
#' electrophysiological data." \emph{Computational Intelligence and
#' Neuroscience}, 2011, 156869.
#' @seealso \code{\link{setEvents}} for attaching events,
#'   \code{\link{addEvents}} for appending events,
#'   \code{\link{removeEvents}} for removing events,
#'   \code{\link{nEvents}} for event count
#' @export
#' @examples
...
#' electrophysiological data." \emph{Computational Intelligence and
#' Neuroscience}, 2011, 156869.
#' @seealso \code{\link{getEvents}} for retrieving events,
#'   \code{\link{addEvents}} for appending events,
#'   \code{\link{PhysioEvents}} for the event constructor
#' @export
#' @examples
#' pe <- PhysioExperiment(
#'   assays = list(raw = matrix(rnorm(1000), nrow = 100)),
...
#' electrophysiological data." \emph{Computational Intelligence and
#' Neuroscience}, 2011, 156869.
#' @seealso \code{\link{setEvents}} for replacing all events,
#'   \code{\link{removeEvents}} for removing events,
#'   \code{\link{getEvents}} for retrieving events,
#'   \code{\link{nEvents}} for event count
#' @export
...
#' @seealso \code{\link{getEvents}} for retrieving events,
#'   \code{\link{addEvents}} for appending events,
#'   \code{\link{setEvents}} for replacing all events
#' @examples
#' pe <- PhysioExperiment(
#'   assays = list(raw = matrix(rnorm(1000), nrow = 100)),
#'   samplingRate = 100
...
#' of single-trial EEG dynamics." \emph{Journal of Neuroscience Methods},
#' 134(1), 9-21.
#' @seealso \code{\link{samplesToTime}} for the inverse conversion,
#'   \code{\link{samplingRate}} for the sampling rate,
#'   \code{\link{timeIndex}} for the full time vector
#' @examples
#' pe <- PhysioExperiment(
#'   assays = list(raw = matrix(rnorm(1000), nrow = 100)),
#'   samplingRate = 100
...
#' of single-trial EEG dynamics." \emph{Journal of Neuroscience Methods},
#' 134(1), 9-21.
#' @seealso \code{\link{timeToSamples}} for the inverse conversion,
#'   \code{\link{samplingRate}} for the sampling rate,
#'   \code{\link{timeIndex}} for the full time vector
#' @examples
#' pe <- PhysioExperiment(
...
#' @return Returns \code{NULL} invisibly; called for the side effect of printing
#'   a compact summary of the events to the console.
#' @seealso \code{\link{PhysioEvents}} for the constructor,
#'   \code{\link{nEvents}} for event count
#' @export
