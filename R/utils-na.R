...
#' @seealso \code{\link{hasNA}} for quick NA presence check,
#'   \code{\link{naSummary}} for per-assay NA statistics,
#'   \code{\link{handleNA}} for NA replacement strategies
#' @export
#' @examples
#' pe <- PhysioExperiment(
...
#' electrophysiological data." \emph{Computational Intelligence and
#' Neuroscience}, 2011, 156869.
#' @seealso \code{\link{replaceNA}} for handling NA in PhysioExperiment assays,
#'   \code{\link{fillEdgeNA}} for edge-specific NA filling,
#'   \code{\link{checkNA}} for NA validation
#' @export
#' @examples
#' x <- c(1, NA, 3, NA, 5)
#'
...
#' electrophysiological data." \emph{Computational Intelligence and
#' Neuroscience}, 2011, 156869.
#' @seealso \code{\link{handleNA}} for general NA handling strategies,
#'   \code{\link{replaceNA}} for NA handling in PhysioExperiment assays
#' @export
#' @examples
...
#' electrophysiological data." \emph{Computational Intelligence and
#' Neuroscience}, 2011, 156869.
#' @seealso \code{\link{checkNA}} for detailed NA statistics,
#'   \code{\link{naSummary}} for per-assay NA summary,
#'   \code{\link{replaceNA}} for handling NA values
#' @export
#' @examples
#' pe <- PhysioExperiment(
...
#' electrophysiological data." \emph{Computational Intelligence and
#' Neuroscience}, 2011, 156869.
#' @seealso \code{\link{hasNA}} for quick NA check,
#'   \code{\link{checkNA}} for detailed NA validation,
#'   \code{\link{replaceNA}} for handling NA values
#' @export
#' @examples
#' pe <- PhysioExperiment(
...
#' electrophysiological data." \emph{Computational Intelligence and
#' Neuroscience}, 2011, 156869.
#' @seealso \code{\link{handleNA}} for the underlying NA handling strategies,
#'   \code{\link{checkNA}} for NA validation,
#'   \code{\link{hasNA}} for quick NA presence check
#' @export
#' @examples
#' pe <- PhysioExperiment(
